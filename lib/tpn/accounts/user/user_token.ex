defmodule Tpn.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Tpn.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :administrator, Tpn.Accounts.Administrator
  ...
  def build_session_token(user, context) do
    ...
    case context do
      "admin-session" ->
        {token, %UserToken{token: token, context: context, administrator_id: user.id}}
