        ...
        <div class="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <!-- Profile dropdown -->
            <div id="profile-dropdown-menu" class="dropdown-menu">
              <button type="button" id="profile-dropdown-menu-trigger" aria-haspopup="menu" aria-controls="profile-dropdown-menu-menu" aria-expanded="false" class="btn-sm-outline flex items-center gap-4">
                <span><%= @name %></span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-muted-foreground ml-auto"><path d="m7 15 5 5 5-5"></path><path d="m7 9 5-5 5 5"></path></svg>
              </button>
              <div id="profile-dropdown-menu-popover" data-popover data-side="bottom" data-align="end" data-offset="0" aria-hidden="true" class="min-w-32">
                <div role="menu" id="profile-dropdown-menu-menu" aria-labelledby="profile-dropdown-menu-trigger">
                  <div role="menuitem">
