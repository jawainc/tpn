...
# RUN - curl -fsSL https://deb.nodesource.com/gpgkey/nodesource.gpg.key | gpg --dearmor > /etc/apt/keyrings/nodesource.gpg
# RUN apt-get update
# RUN NODE_VERSION=21
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/tpn ./
